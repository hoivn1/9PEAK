<div align="center">
  ...
  **A downstream fork of [9Router](https://github.com/decolua/9router) by [@decolua](https://github.com/decolua), maintained by [Hoivn1 GitHub](https://github.com/hoivn1).**
  ...
  Image-generation focus with subscription-account routing. Drop-in replacement for 9Router on the same `localhost:20128` endpoint.
  ...
  [![Attribution](https://img.shields.io/badge/attribution-NOTICE.md-orange)](./NOTICE.md)

  [🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Setup](#-setup-guide) • [🙏 Credits](#-original-9router--credits)
...
>
> 9Peak only adds a thin layer of image-generation features and bug fixes on top. See [NOTICE.md](./NOTICE.md) and [docs/FORK_FEATURES.md](./docs/FORK_FEATURES.md) for the full attribution and the list of fork-specific changes.
>
> If you find 9Router useful, **please star and support the upstream project first**: https://github.com/decolua/9router
>
> Bug reports for non-fork-specific issues should be filed upstream.

---

## 📘 About 9Router (upstream)

The sections below describe the underlying 9Router product, written by @decolua. 9Peak inherits all of these features unchanged unless explicitly noted.
...
**[9Peak](https://github.com/hoivn1/CCHEATCLI)** — *This repository.* JavaScript fork of 9Router maintained by Hoivn1 GitHub, focused on image-generation routing through subscription accounts (ChatGPT Plus/Pro, Gemini Pro). Drop-in replacement on the same `localhost:20128` endpoint. See [NOTICE.md](./NOTICE.md) for attribution and [docs/FORK_FEATURES.md](./docs/FORK_FEATURES.md) for the change list.
...
Original 9Router © 2024–2026 [decolua](https://github.com/decolua) and contributors. 9Peak fork modifications © 2026 Hoivn1 GitHub.

---

<div align="center">
  <sub>Built with ❤️ by <a href="https://github.com/decolua">@decolua</a> for developers who code 24/7. 9Peak fork by Hoivn1 GitHub.</sub>
</div>
