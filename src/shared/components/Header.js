...
const getPageInfo = (pathname) => {
  ...
  if (pathname.includes("/mitm"))
    return {
      title: "MITM Proxy",
      description: "Intercept CLI tool traffic and route through 9Peak",
      icon: "security",
      breadcrumbs: [],
    };
...
export default function Header({ onMenuClick, showMenuButton = true }) {
  ...
  return (
    <header className="flex items-center justify-between px-8 py-5 border-b border-black/5 dark:border-white/5 bg-bg/95 z-10 sticky top-0">
      {/* Mobile menu button */}
